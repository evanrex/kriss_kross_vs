            ...
            child: Column(
              children: <Widget>[
                ...
                DropdownButtonFormField(
                  ...
                  onChanged: (value) => setState(() => _desiredETA = value),
                ),
                ...
                DropdownButtonFormField(
                  ...
                  items: widget.location.pickUpLocations.map((point) {
                    return DropdownMenuItem(
                        value: point, child: Text('Board at: ' + '$point'));
                  }).toList(),
                  onChanged: (value) => setState(() => _desiredPickUp = value),
                ),
                ...
                Text(pickupTime(
                    widget.location.travelTimes, _desiredPickUp, _desiredETA)),
                SizedBox(height: 20.0),
                Row(
                  children: [
                    ElevatedButton(
